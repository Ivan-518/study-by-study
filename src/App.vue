...
<template>
  <div class="app-shell"><AppSidebar :active="store.page" @navigate="navigate" /><component :is="currentView" :query="store.query" :selected="store.selectedSources" :notes="store.notes" :learning-items="store.learningItems" @navigate="navigate" @search="store.search" @ask="openAssistant" @add="store.addNote" @remove="store.removeNote" @add-learning="store.addLearningItem" @set-learning-status="store.setLearningStatus" @remove-learning="store.removeLearningItem" />
